...
public int getColumnCount(){
            try{
                ...
                System.out.println("getColumncount resultset generating error while getting column count"); //si on a un erreur voici le message va recevoir
 ...
 public int getRowcount(){
    ...
    public Object getValueAt(int rowIndex, int columnIndex){
        if (rowIndex < 0 || columnIndex > getColumnCount()
